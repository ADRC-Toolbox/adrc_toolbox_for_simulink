...
%% Save figures
saveas(fig_1,'simulation_procedures/noise_no_saturation_control_error', 'epsc');
saveas(fig_2,'simulation_procedures/noise_no_saturation_control_signal', 'epsc');
saveas(fig_3,'simulation_procedures/noise_no_saturation_output', 'epsc');